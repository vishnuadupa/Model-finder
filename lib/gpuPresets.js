...
export const GPU_PRESETS = [
  ...
  // M5 series — TSMC 3nm N3P, LPDDR5X 9600 MT/s, Fusion Architecture (Pro/Max/Ultra)
  // M5 Ultra: projected specs based on dual-M5-Max UltraFusion (expected Oct 2026)
  { label: 'Apple M5 Ultra 80c',  vram: 0, unified: true, maxRam: 256, flashAttn: true, bandwidth: 1100, memType: 'LPDDR5X', pcie: null, buyUrl: null },
  { label: 'Apple M5 Max 40c',    vram: 0, unified: true, maxRam: 128, flashAttn: true, bandwidth: 614,  memType: 'LPDDR5X', pcie: null, buyUrl: null },
  { label: 'Apple M5 Pro 20c',    vram: 0, unified: true, maxRam: 64,  flashAttn: true, bandwidth: 307,  memType: 'LPDDR5X', pcie: null, buyUrl: null },
  { label: 'Apple M5',            vram: 0, unified: true, maxRam: 32,  flashAttn: true, bandwidth: 154,  memType: 'LPDDR5X', pcie: null, buyUrl: null },
  // M4 series — TSMC 3nm N3E, LPDDR5X
