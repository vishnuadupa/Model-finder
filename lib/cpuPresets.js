...
export const CPU_PRESETS = [
  ...
  { label: 'Intel Core Ultra 9 285K',     tier: 'ultra', cores: 24, vendor: 'Intel', ramBandwidthFactor: 1.05 },
  ...
  { label: 'Intel Core Ultra 7 265K',     tier: 'high',  cores: 20, vendor: 'Intel', ramBandwidthFactor: 0.95 },
  ...
  { label: 'Intel Core Ultra 5 245K',     tier: 'mid',   cores: 14, vendor: 'Intel', ramBandwidthFactor: 0.80 },
  ...
  // M5 series — 6 super cores + 12 perf cores (Pro/Max/Ultra), TSMC N3P
  // M5 Ultra: projected (2x M5 Max UltraFusion, expected Oct 2026)
  { label: 'Apple M5 Ultra (CPU)',        tier: 'ultra', cores: 36, vendor: 'Apple', ramBandwidthFactor: 1.45, apple: true },
  { label: 'Apple M5 Max (CPU)',          tier: 'ultra', cores: 18, vendor: 'Apple', ramBandwidthFactor: 1.35, apple: true },
  { label: 'Apple M5 Pro (CPU)',          tier: 'ultra', cores: 18, vendor: 'Apple', ramBandwidthFactor: 1.25, apple: true },
  { label: 'Apple M5 (CPU)',              tier: 'high',  cores: 10, vendor: 'Apple', ramBandwidthFactor: 1.10, apple: true },
  // M4 series — TSMC N3E
...
export const RAM_TYPES = [
  ...
  { label: 'LPDDR5X 9600 (Apple M5)', type: 'LPDDR5X', speedMHz: 9600, bandwidthGBs: 154, factor: 1.15, desc: 'M5 / M5 Pro / M5 Max / M5 Ultra — N3P LPDDR5X' },
